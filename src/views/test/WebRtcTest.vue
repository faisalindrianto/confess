    ...
    <v-card class="mx-8 main d-flex flex-column">
      <div class="d-flex video-top">
        ...
        >
          ...
          >
            <div class="d-flex align-center h-100 w-100 justify-center primary rounded">
              <v-avatar size="48">
          ...
          >
            <v-card
              v-for="i in 8"
              :key="i"
              :min-width="showSidebar && screenState ? '200px' : '500px'"
              :max-width="showSidebar && screenState ? '200px' : '500px'"
              elevation="0"
              class="mr-2 mb-2 flex-grow-1"
            >
              <div class="aspect916">
                <div class="d-flex align-center h-100 w-100 justify-center secondary rounded">
                  <v-avatar size="48">
                    <v-img src="@/assets/images/avatars/1.png"></v-img>
                  </v-avatar>
                </div>
            ...
            <v-card
              ...
              :key="stream.peerId"
              :min-width="showSidebar ? '200px' : '500px'"
              max-width="100px"
              elevation="0"
              class="mr-2 mb-2 flex-grow-1"
            >
...
import preferCodec from '@/views/app/codec'
...
export default {
  ...
  setup(props) {
    ...
    const participantRef = db.collection('meets').doc(props.id).collection('participants')
